<?php
    ...
    foreach ($resLogQuery as $elem) {
        ...
        echo "<td style='color: #E6855F; height: 70px;'>" . $elem['price'] . " $</td>";
    ...
    echo "<tr><td style='color: #003559; height: 70px; font-weight: bold'>Total: </td><td style='color: #E6855F; height: 70px;'>$total $</td><td><form method='post'><input style='padding: 10px; margin-top: 10px;' type='submit' name='order' value='Order'></form></td></tr>";
    echo "</table>";
    echo "</div>";
    echo "</div>";
